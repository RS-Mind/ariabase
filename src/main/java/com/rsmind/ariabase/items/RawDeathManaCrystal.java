...
import com.rsmind.ariabase.entity.RawDeathManaCrystalEntity;
...
public class RawDeathManaCrystal extends Item {

	public RawDeathManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawDeathManaCrystalEntity rawmanacrystalentity = new RawDeathManaCrystalEntity(worldIn, playerIn);
