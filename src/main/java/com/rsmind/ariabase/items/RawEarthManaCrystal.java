...
import com.rsmind.ariabase.entity.RawEarthManaCrystalEntity;
...
public class RawEarthManaCrystal extends Item {

	public RawEarthManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawEarthManaCrystalEntity rawmanacrystalentity = new RawEarthManaCrystalEntity(worldIn, playerIn);
