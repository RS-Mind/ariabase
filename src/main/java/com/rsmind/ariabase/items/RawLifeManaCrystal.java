...
import com.rsmind.ariabase.entity.RawLifeManaCrystalEntity;
...
public class RawLifeManaCrystal extends Item {

	public RawLifeManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawLifeManaCrystalEntity rawmanacrystalentity = new RawLifeManaCrystalEntity(worldIn, playerIn);
