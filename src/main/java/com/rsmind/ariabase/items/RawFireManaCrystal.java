...
import com.rsmind.ariabase.entity.RawFireManaCrystalEntity;
...
public class RawFireManaCrystal extends Item {

	public RawFireManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawFireManaCrystalEntity rawmanacrystalentity = new RawFireManaCrystalEntity(worldIn, playerIn);
