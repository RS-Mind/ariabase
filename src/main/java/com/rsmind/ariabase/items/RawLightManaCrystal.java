...
import com.rsmind.ariabase.entity.RawLightManaCrystalEntity;
...
public class RawLightManaCrystal extends Item {

	public RawLightManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawLightManaCrystalEntity rawmanacrystalentity = new RawLightManaCrystalEntity(worldIn, playerIn);
