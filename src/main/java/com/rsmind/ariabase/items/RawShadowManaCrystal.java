...
import com.rsmind.ariabase.entity.RawShadowManaCrystalEntity;
...
public class RawShadowManaCrystal extends Item {

	public RawShadowManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawShadowManaCrystalEntity rawmanacrystalentity = new RawShadowManaCrystalEntity(worldIn, playerIn);
