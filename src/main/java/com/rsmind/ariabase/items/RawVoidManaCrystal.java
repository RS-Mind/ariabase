...
import com.rsmind.ariabase.entity.RawVoidManaCrystalEntity;
...
public class RawVoidManaCrystal extends Item {

	public RawVoidManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawVoidManaCrystalEntity rawmanacrystalentity = new RawVoidManaCrystalEntity(worldIn, playerIn);
