...
import com.rsmind.ariabase.entity.RawWaterManaCrystalEntity;
...
public class RawWaterManaCrystal extends Item {

	public RawWaterManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawWaterManaCrystalEntity rawmanacrystalentity = new RawWaterManaCrystalEntity(worldIn, playerIn);
