...
import com.rsmind.ariabase.entity.RawEnergyManaCrystalEntity;
...
public class RawEnergyManaCrystal extends Item {

	public RawEnergyManaCrystal() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (!worldIn.isRemote) {
	         RawEnergyManaCrystalEntity rawmanacrystalentity = new RawEnergyManaCrystalEntity(worldIn, playerIn);
