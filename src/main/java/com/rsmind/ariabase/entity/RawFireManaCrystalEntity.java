...
public class RawFireManaCrystalEntity extends ProjectileItemEntity {
	public int explosionPower = 1;
	   
	public RawFireManaCrystalEntity(EntityType<? extends RawFireManaCrystalEntity> p_i50159_1_, World p_i50159_2_) {
		super(p_i50159_1_, p_i50159_2_);
		}

	public RawFireManaCrystalEntity(World worldIn, LivingEntity throwerIn) {
		super(EntityType.SNOWBALL, throwerIn, worldIn);
		}

   public RawFireManaCrystalEntity(World worldIn, double x, double y, double z) {
   ...
   private IParticleData makeParticle() {
      ...
      return (IParticleData)(itemstack.isEmpty() ? new ItemParticleData(ParticleTypes.ITEM, new ItemStack(ModItems.RAW_MANA_CRYSTAL_FIRE.get())) : new ItemParticleData(ParticleTypes.ITEM, itemstack));
   }
